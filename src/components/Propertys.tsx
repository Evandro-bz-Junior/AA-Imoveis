    ...
    return (
        <section id="imoveis" className="w-full  flex items-center py-14 bg-section1">
            <div className="container flex flex-col   justify-center    mx-auto px-4 gap-8">
                ...
                <div className="infoArea flex flex-col   justify-center gap-4 mb-6">
                    <h1 className="text-4xl">Imóveis selecionados</h1>
                    <span>Oportunidades escolhidas para morar ou investir com segurança.</span>
                </div>

                <div className="cardsArea grid grid-cols-3 gap-4 items-stretch">
                    ...
                    <button className="block mx-auto px-8 py-2 w-52 text-center bg-section1 text-text2  rounded-full  border hover:bg-primary hover:text-text1 transition-colors duration-300 active:scale-95 font-medium">Ver mais imóveis</button>
            </div>
        </section  >
    );
}